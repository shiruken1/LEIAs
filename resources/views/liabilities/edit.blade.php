...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Liabilities / Edit #{{$liability->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('liabilities.update', $liability->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('capital_id')) has-error @endif">
                    ...
                    <input type="text" id="capital_id-field" name="capital_id" class="form-control" value="{{ $liability->capital_id }}"/>
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ $liability->name }}"/>
                       @if($errors->has("name"))
                    ...
                    <input type="text" id="amount-field" name="amount" class="form-control" value="{{ $liability->amount }}"/>
                    ...
                    <input type="text" id="growth_rate-field" name="growth_rate" class="form-control" value="{{ $liability->growth_rate }}"/>
                    ...
                    <input type="text" id="pattern-field" name="pattern" class="form-control" value="{{ $liability->pattern }}"/>
                    ...
                    <input type="text" id="cycle_up-field" name="cycle_up" class="form-control" value="{{ $liability->cycle_up }}"/>
                    ...
                    <input type="text" id="cycle_down-field" name="cycle_down" class="form-control" value="{{ $liability->cycle_down }}"/>
                ...
                <div class="well well-sm">
                    ...
                    <a class="btn btn-link pull-right" href="{{ route('liabilities.index') }}"><i class="glyphicon glyphicon-backward"></i>  Back</a>
                </div>
            </form>
