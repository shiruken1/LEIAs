...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-plus"></i> Capitals / Create </h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('capitals.store') }}" method="POST">
                ...
                <div class="form-group @if($errors->has('name')) has-error @endif">
                    ...
                    <input type="text" id="start_at-field" name="start_at" class="form-control" value="{{ old("start_at") }}"/>
                    ...
                    <input type="text" id="end_at-field" name="end_at" class="form-control" value="{{ old("end_at") }}"/>
                    ...
                    <input type="text" id="date_start-field" name="date_start" class="form-control" value="{{ old("date_start") }}"/>
                    ...
                    <input type="text" id="date_end-field" name="date_end" class="form-control" value="{{ old("date_end") }}"/>
                    ...
                    <input type="text" id="income_start-field" name="income_start" class="form-control" value="{{ old("income_start") }}"/>
                    ...
                    <input type="text" id="income_end-field" name="income_end" class="form-control" value="{{ old("income_end") }}"/>
                    ...
                    <input type="text" id="expenses_start-field" name="expenses_start" class="form-control" value="{{ old("expenses_start") }}"/>
                    ...
                    <input type="text" id="expenses_end-field" name="expenses_end" class="form-control" value="{{ old("expenses_end") }}"/>
