...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Incomes / Edit #{{$income->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('incomes.update', $income->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('capital_id')) has-error @endif">
                    ...
                    <input type="text" id="capital_id-field" name="capital_id" class="form-control" value="{{ $income->capital_id }}"/>
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ $income->name }}"/>
                       @if($errors->has("name"))
                    ...
                    <input type="text" id="amount-field" name="amount" class="form-control" value="{{ $income->amount }}"/>
                    ...
                    <input type="text" id="growth_rate-field" name="growth_rate" class="form-control" value="{{ $income->growth_rate }}"/>
                    ...
                    <input type="text" id="pattern-field" name="pattern" class="form-control" value="{{ $income->pattern }}"/>
                    ...
                    <input type="text" id="cycle_up-field" name="cycle_up" class="form-control" value="{{ $income->cycle_up }}"/>
                    ...
                    <input type="text" id="cycle_down-field" name="cycle_down" class="form-control" value="{{ $income->cycle_down }}"/>
