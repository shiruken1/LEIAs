...
@section('header')
    <div class="page-header">
        <h1><i class="glyphicon glyphicon-edit"></i> Assets / Edit #{{$asset->id}}</h1>
    </div>
@endsection
        ...
        <div class="col-md-12">
            ...
            <form action="{{ route('assets.update', $asset->id) }}" method="POST">
                ...
                <div class="form-group @if($errors->has('capital_id')) has-error @endif">
                    ...
                    <input type="text" id="capital_id-field" name="capital_id" class="form-control" value="{{ $asset->capital_id }}"/>
                    ...
                    <input type="text" id="name-field" name="name" class="form-control" value="{{ $asset->name }}"/>
                       @if($errors->has("name"))
                    ...
                    <input type="text" id="amount-field" name="amount" class="form-control" value="{{ $asset->amount }}"/>
                    ...
                    <input type="text" id="growth_rate-field" name="growth_rate" class="form-control" value="{{ $asset->growth_rate }}"/>
                    ...
                    <input type="text" id="pattern-field" name="pattern" class="form-control" value="{{ $asset->pattern }}"/>
                    ...
                    <input type="text" id="cycle_up-field" name="cycle_up" class="form-control" value="{{ $asset->cycle_up }}"/>
                    ...
                    <input type="text" id="cycle_down-field" name="cycle_down" class="form-control" value="{{ $asset->cycle_down }}"/>
